...
constants.statedefinitiondomain = 'viabilityproblem.statedefinitiondomain'
...
constants.parameters_dynamicsparametervalues = 'parameters.dynamicsparametervalues'
...
constants.results_explorationdomain = 'results.explorationdomain'
